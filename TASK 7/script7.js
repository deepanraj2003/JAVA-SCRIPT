// ======================================================
// JAVASCRIPT ASSIGNMENT - SCRIPT7.JS
// ======================================================
...

{
    ...
    fetch(api)
        ...
        .then(products => {
            ...
            let electronics =
                countCategory(products, "electronics");

            let jewelery =
                countCategory(products, "jewelery");

            let mensClothing =
                countCategory(products, "men's clothing");

            let womensClothing =
                countCategory(products, "women's clothing");
...

{
    ...
    fetch(usersAPI)
        ...
        .then(posts => {
            ...
            console.log(
                "===== FIRST TITLE ABOVE 50 CHARACTERS ====="
            );
